...
adams({
  ...
  await _0x3a058d.sendMessage(_0x42b1bf, {
    ...
    'caption': "_╰►VIDEO DOWNLOADED BY_ *CRAZY-BOT*",
    'gifPlayback': false
  }, {
    'quoted': _0x333a0e
  });
...
adams({
  ...
  try {
    ...
    _0x42db7e.sendMessage(_0x38d623, {
      ...
      'caption': "_╰►IMAGE DOWNLOADED BY_ *CRAZY-BOT*",
      'gifPlayback': false
    }, {
      'quoted': _0x529878
    });
...
adams({
  ...
  try {
    ...
    console.error("An error occurred while *CRAZY-BOT* was downloading your media:", _0x1d71c9);
...
adams({
  ...
  try {
    ...
    console.error("An error occurred while Crazy-Bot was downloading your media:", _0x2b1e09);
    _0x55e155("An error occurred while Crazy-Bot was downloading your media.", _0x2b1e09);
  }
});
...
adams({nomCom : "instagram" , categorie : "Download"},async (dest , zk , commandeOptions)=>{
  ...
  try {
    ...
    zk.sendMessage(dest,{video : {url : igvid.data.data.data[0].url},caption : "ig video downloader powered by *Crazy-Bot*",gifPlayback : false },{quoted : ms}) 
    }
    else {
        zk.sendMessage(dest,{image : {url : igvid.data.data.data[0].url},caption : "ig image downloader powered by *Crazy-Bot*"})
    }
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.hd  }, caption: 'facebook video downloader powered by *CRAZY-BOT*' }, { quoted: ms });
...
async (dest, zk, commandeOptions) => {
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       zk.sendMessage(dest,{image : { url : result.thumbnail}, caption : caption},{quoted : ms}) ;
       zk.sendMessage(dest, { video: { url: result.sd  }, caption: 'facebook video downloader powered by *Crazy-Bot*' }, { quoted: ms });
